...
namespace Olaf
{
    public static class SpellManager
    {
        ...
        {
            Q = new Spell(SpellSlot.Q, 1000, TargetSelector.DamageType.Physical);    
            W = new Spell(SpellSlot.W);
            E = new Spell(SpellSlot.E, 325, TargetSelector.DamageType.True);
            R = new Spell(SpellSlot.R);
            
            Q.SetSkillshot(0.25f, 75, 1550, false, SkillshotType.SkillshotLine);
        }
