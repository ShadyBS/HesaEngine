...
namespace Ekko
{
    public static class SpellManager
    {
        ...
        public static void LoadSpells()
        {
            ...
            W = new Spell(SpellSlot.W, 1600, TargetSelector.DamageType.Magical);
            E = new Spell(SpellSlot.E, 450, TargetSelector.DamageType.Magical);
            R = new Spell(SpellSlot.R, 375, TargetSelector.DamageType.Magical);
            
            Q.SetSkillshot(0.25f, 60, 2200, false, SkillshotType.SkillshotLine);
			W.SetSkillshot(0.5f, 650, 1500, false, SkillshotType.SkillshotCircle);

			Main.EkkoRGhost = ObjectManager.Get<Obj_GeneralParticleEmitter>().FirstOrDefault(x => x.Name.Equals("Ekko_Base_R_TrailEnd.troy"));
		}
